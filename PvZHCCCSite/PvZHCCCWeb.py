...
z = [sg.Text('Strength'), sg.Input(size=(3, 10), key='-STINPUT-'), sg.Text('Health'), sg.Input(size=(3, 10),key='-HEINPUT-')],[sg.Text('1', visible=False)]

# form layout
inputs = [     
            [sg.Text('Name'), sg.Input(size=(12, 10), key='-NINPUT-'), sg.Text('Cost'), sg.Input(size=(3, 10), key='-COINPUT-')], 
            [sg.Column(z, key='-c-')],
            [sg.Text('Card Type'), sg.Combo(types, size=(20, 10), enable_events=True,  readonly=True, key='-TCOMBO-')],
            [sg.Text('Class'), sg.Combo(classes, size=(10, 10), enable_events=True,  readonly=True,  key='-CCOMBO-')],
            [sg.Text('Tribes'), sg.Input(size=(10, 10), key='-TRINPUT-')],
            [sg.Text('Card Text')],
            [sg.Multiline(size=(10, 10), enable_events=True, key='-CARDTEXT-')],
            [sg.Text('Rarity'), sg.Combo(rarity, size=(10, 10), enable_events=True, readonly=True, key='-RCOMBO-')],
            [sg.Text('Set'), sg.Input('Premium', size=(10, 10), key='-SETINPUT-')],
            [sg.Text('Flavour Text')],
            [sg.Multiline(size=(10, 3), key='-FLAVOURTEXT-')], 
         ]
...
card = [    
            ...
            [sg.Text('Adjust Card Art Position'),
            ...
            [sg.Text('Change Background'), sg.Combo(['PvZ Heroes Website', 'PvZ Heroes Lawn', 'Transparent'], default_value='PvZ Heroes Website', enable_events=True,  readonly=True, key='-BACKGROUNDSELECT-')],
            # options to save the image
            [sg.Text('Save Image')],
            [sg.Input(size=(25, 1), enable_events=True, key="-SAVEIMAGE-"),
            sg.FolderBrowse(),
